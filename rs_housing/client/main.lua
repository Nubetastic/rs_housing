            ...
            if PromptHasHoldModeCompleted(prompt.prompt) then
              ...
              if prompt.type == 'SELL' then
                ...
                if input and input[1] then
                  ...
                  if inputId == GetPlayerServerId(PlayerId()) then
                    exports.rs_housing:ShowAdvancedNotification( Locales['HOUSING_NOTI'], Locales['REAL_ESTATE_SELL_TO_SELF'], "menu_textures", "cross", 3000, "COLOR_RED")
                    PlayerData.IsBusy = false
              ...
              elseif prompt.type == "BUY" then
                ...
                if isPermittedToBuy then
                  ...
                  exports.rs_housing:ShowAdvancedNotification( Locales['HOUSING_NOTI'], Locales['REACHED_MAX_PROPERTIES'], "menu_textures", "cross", 3000, "COLOR_RED")
                end
                        ...
                        if PromptHasHoldModeCompleted(TeleportPromptsList) then
                            ...
                            if distanceType == "PRIMARY" then
                                ...
                                if HasPropertyAccess(property) then
                                    ...
                                    exports.rs_housing:ShowAdvancedNotification( Locales['HOUSING_NOTI'], Locales['NOT_ALLOWED_TO_ENTER'], "menu_textures", "cross", 3000, "COLOR_RED")
                                    FreezeEntityPosition(PlayerPedId(), false)
                                    Wait(1000)
                                end
